...
namespace YantraJS.Core.Tests.Imported
{
        ...
        public class NumberTests : TestBase
        {
            ...
            public void Properties()
            {
                ...
                //Non Strict Mode
                Assert.AreEqual("TypeError", EvaluateExceptionType("delete Number.MAX_VALUE"));
            ...
            public void toLocaleString()
            {
                ...
                try
                {
                    ...
                    Assert.AreEqual("123456789", Evaluate("123456789 .toLocaleString()"));
                    Assert.AreEqual("-500", Evaluate("(-500).toLocaleString()"));
                    Assert.AreEqual(System.Globalization.CultureInfo.CurrentCulture.NumberFormat.PositiveInfinitySymbol, Evaluate("Infinity.toLocaleString()"));
        ...
        {
            Assert.AreEqual("12345", Evaluate("12345 .toString()"));
            Assert.AreEqual("18014398509481992", Evaluate("18014398509481992 .toString()")); //modified
            Assert.AreEqual("18014398509482008", Evaluate("18014398509482008 .toString()")); //modified
            Assert.AreEqual("18014398509482012", Evaluate("18014398509482012 .toString()"));
            Assert.AreEqual("18014398509481988", Evaluate("18014398509481988 .toString()"));
            Assert.AreEqual("1234567890123456768", Evaluate("1234567890123456789 .toString()")); //modified
            Assert.AreEqual("2234567890123456768", Evaluate("2234567890123456789 .toString()")); //modified
            Assert.AreEqual("3234567890123457024", Evaluate("3234567890123456789 .toString()")); //modified
            Assert.AreEqual("4234567890123457024", Evaluate("4234567890123456789 .toString()")); //modified
            Assert.AreEqual("72057594037927936", Evaluate("72057594037927944 .toString()")); // modified
            Assert.AreEqual("72057594037927952", Evaluate("72057594037927945 .toString()")); // modified
            Assert.AreEqual("72057594037927952", Evaluate("72057594037927959 .toString()"));
            Assert.AreEqual("9.999999999999998", Evaluate("9.999999999999999.toString()"));
            Assert.AreEqual("10", Evaluate("9.9999999999999999.toString()"));
            Assert.AreEqual("100000000000000000000", Evaluate("99999999999999999999 .toString()"));
            Assert.AreEqual("999999999999990038528", Evaluate("999999999999990000000 .toString()")); // modified
            Assert.AreEqual("1e+21", Evaluate("999999999999999999999 .toString()"));
            Assert.AreEqual("100000000000000000000", Evaluate("99999999999999999999 .toString()"));
            Assert.AreEqual("9.99999999999999e-12", Evaluate("(0.00000000000999999999999999).toString()"));
            Assert.AreEqual("-999999999999", Evaluate("(-999999999999).toString()"));
            ...
            Assert.AreEqual("-Infinity", Evaluate("(-Infinity).toString()"));
            Assert.AreEqual("NaN", Evaluate("NaN.toString()"));
            Assert.AreEqual("1.79769313486231570815e+308", Evaluate("Number.MAX_VALUE.toString()"));
            Assert.AreEqual("5e-324", Evaluate("Number.MIN_VALUE.toString()"));
