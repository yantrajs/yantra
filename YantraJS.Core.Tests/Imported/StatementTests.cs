...
namespace YantraJS.Core.Tests.Imported
{
    ...
    public class StatementTests : TestBase
    {
        ...
        public void Function()
        {
            ...
            Assert.IsInstanceOfType(Evaluate("var a; function a() { return 6 }; a"), typeof(JSFunction));
            Assert.IsInstanceOfType(Evaluate("function a() { return 6 }; var a; a"), typeof(JSFunction));
