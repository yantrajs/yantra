...
namespace YantraJS.Core.FastParser.Compiler
{
    partial class FastCompiler
    {
        ...
        protected override Expression VisitLiteral(AstLiteral literal) {
            ...
            if (this.scope.Top.Loop.Top == null)
            {
                return VisitLiteralInternal(literal);
            }

            return this.scope.Top.GetNewLiteral(VisitLiteralInternal(literal));

            Expression VisitLiteralInternal(AstLiteral literal)
            {
