...
namespace YantraJS.Core.Typed
{
    ...
    public partial class JSInt8Array : JSTypedArray
    {
        ...
        public static JSValue From(in Arguments a)
        {
            ...
            return new JSInt8Array(new TypedArrayParameters(f, map, mapThis, BYTES_PER_ELENENT));
        }

        [JSExport]
        public static JSValue Of(in Arguments a)
        {
            var r = new JSInt8Array(new TypedArrayParameters(a.Length, BYTES_PER_ELENENT));
