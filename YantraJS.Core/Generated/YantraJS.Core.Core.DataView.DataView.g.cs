...
public static JSFunction CreateClass(JSContext context, bool register = true) {
                        ...
                        var @class = new JSClassFunction(context, (in Arguments a) => new DataView(in a)
                            ...
                            , length:3);
                        if (register) {
                            context[KeyString.DataView] = @class;
                        }
...
prototype.FastAddValue(KeyString.getBigInt64, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
...
prototype.FastAddValue(KeyString.getBigUInt64, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
...
prototype.FastAddValue(KeyString.getFloat32, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
...
prototype.FastAddValue(KeyString.getFloat64, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
...
prototype.FastAddValue(KeyString.getInt16, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.GetInt16(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "getInt16"
...
prototype.FastAddValue(KeyString.getInt32, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.GetInt32(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "getInt32"
...
prototype.FastAddValue(KeyString.getInt8, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.GetInt8(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "getInt8"
...
prototype.FastAddValue(KeyString.getUint16, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.GetUint16(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "getUint16"
...
prototype.FastAddValue(KeyString.getUint32, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.GetUint32(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "getUint32"
...
prototype.FastAddValue(KeyString.getUint8, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.GetUint8(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "getUint8"
...
prototype.FastAddValue(KeyString.setBigInt64, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
...
prototype.FastAddValue(KeyString.setBigUInt64, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
...
prototype.FastAddValue(KeyString.setFloat32, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
...
prototype.FastAddValue(KeyString.setFloat64, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
...
prototype.FastAddValue(KeyString.setInt16, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.SetInt16(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "setInt16"
...
prototype.FastAddValue(KeyString.setInt32, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.SetInt32(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "setInt32"
...
prototype.FastAddValue(KeyString.setInt8, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.SetInt8(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "setInt8"
...
prototype.FastAddValue(KeyString.setUint16, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.SetUint16(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "setUint16"
...
prototype.FastAddValue(KeyString.setUint32, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.SetUint32(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "setUint32"
...
prototype.FastAddValue(KeyString.setUint8, new JSFunction(context, (in Arguments a) =>
                    a.This is DataView @this
                        ? @this.SetUint8(in a)
                        : throw JSContext.Current.NewTypeError("Failed to convert this to DataView")
                        , "setUint8"
                        ,"function setUint8() { [native] }", createPrototype: false, length: 2), JSPropertyAttributes.ConfigurableValue);
context.DataView_Prototype = prototype.PrototypeObject;
return @class;
}
}
}
